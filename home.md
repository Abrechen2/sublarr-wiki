...
<div class="nav-grid">
  ...
  <a class="nav-card" href="/user-guide/settings/general"><span class="nc-icon mdi mdi-tune-vertical"></span><div class="nc-body"><div class="nc-title">Settings</div><div class="nc-desc">Full settings reference</div></div></a>
  <a class="nav-card" href="/user-guide/language-profiles"><span class="nc-icon mdi mdi-translate"></span><div class="nc-body"><div class="nc-title">Language Profiles</div><div class="nc-desc">Per-series language targeting</div></div></a>
  ...
  <a class="nav-card" href="/user-guide/integrations"><span class="nc-icon mdi mdi-connection"></span><div class="nc-body"><div class="nc-title">Integrations</div><div class="nc-desc">Sonarr, Radarr, Jellyfin, Emby</div></div></a>
</div>
